 ...
 */
final class Version20210520084951 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE movie (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(255) NOT NULL, original_name VARCHAR(255) NOT NULL, release_date DATE NOT NULL, image VARCHAR(255) NOT NULL, synopsis LONGTEXT NOT NULL, seen TINYINT(1) NOT NULL, watch_list TINYINT(1) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
